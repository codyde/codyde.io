...
<nav
	class="relative mx-auto flex w-full max-w-6xl items-center justify-between border-gray-200
	bg-gray-50 bg-opacity-0 py-8 text-gray-900 dark:border-gray-700 dark:bg-gray-800
